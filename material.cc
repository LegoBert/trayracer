...
/**
*/
//void BSDF(Material const* const material, Ray& ray, vec3 point, vec3 normal)
//{
...
//            ray = { point, normalize(reflected) };
//            return;
//        }
//        else
//        {
//            ray = { point, normalize(normalize(normal) + random_point_on_unit_sphere()) };
//            return;
//        }
//    }
//    else
